...
# ------------------------------------------------------------
PROJECT_ROOT="/Users/vishnu.kumar/cursorai/remittance-assistant"
...
# ------------------------------------------------------------
# 4️⃣  Rename the agent to `remittance_agent`
# ------------------------------------------------------------
