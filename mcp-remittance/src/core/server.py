...
def register_all_tools(mcp_server: FastMCP) -> None:
    ...
    from remittance.countries import register_remittance_tools
    ...
    # REMOVED OLD WALLET TOOLS - Now using remittance tools
    ...
    register_remittance_tools(mcp_server)  # NEW: Remittance tools
